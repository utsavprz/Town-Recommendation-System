...
setwd('D:/')
setwd('CourseWorks/DataScienceAssessment/CourseWorkFiles/Datasets')




# HOUSEPRICE DATA CLEANING

# setting working directory

# reading and storing data set to variable
hh2019 = read_csv('HousePrices/HH-2019.csv', show_col_types = FALSE)
hh2020 = read_csv('HousePrices/HH-2020.csv', show_col_types = FALSE)
hh2021 = read_csv('HousePrices/HH-2021.csv')
...
Broadband = read_csv("Broadband/broadbandspeed.csv", show_col_types = FALSE)
